...
if(isset($_POST['email'])) {
	...
	// GENERIC TLS: 	$transport = Swift_SmtpTransport::newInstance('mail.mediumra.re', 25, 'tls') -*** change this***-
	...
	$message = Swift_Message::newInstance('A message from Badass Brewing Company')
