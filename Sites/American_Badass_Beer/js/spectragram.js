        ...
        fetch: function (getData) {
            ...
            if (results.data.length === 0)
            ...
            else
				{
					...
					self.$elem.append($(self.options.wrapEachWith).append("<div class='i-hover'><div class='i-container'><i style='color:white;font-size:50px;' class='icon social_instagram_square'></i></div></div><a title='Pic' target='_blank' href='" + results.data[i].link + "'><img src='" + size + "'></img></a>"));
				}
            }
